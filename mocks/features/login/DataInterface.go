...
// GetToken provides a mock function with given fields: id
func (_m *DataInterface) GetToken(id uint) error {
	ret := _m.Called(id)
...
// InsertToken provides a mock function with given fields: idMentee
func (_m *DataInterface) InsertToken(idMentee uint) error {
